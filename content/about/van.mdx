...
We opted for flexibile monocrystiline solar panels so we could mount them using heavy duty recloseable fasteners.
...
- **Power source**. 100W from an inverter (120VAC) is highter voltage and lower current for the equivalent wattage using a car battery (12VDC).
